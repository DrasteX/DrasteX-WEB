...
document.addEventListener("DOMContentLoaded",()=>{
    ...
    // USER OPTIONS
    const user_option_button_be = document.getElementById('user_menu_button_right');
    const user_option_container_be = document.querySelector('.user_options');

    user_option_container_be.style.display = "none";
    user_option_button_be.addEventListener('click',()=>{
        if (user_option_container_be.style.display == "none") {
            user_option_container_be.style.display = "flex";
        } else {
            user_option_container_be.style.display = "none";
        }
    })
